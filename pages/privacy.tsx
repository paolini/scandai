export default function Privacy({}) {
  ...
  <p>Questa pagina descrive le pratiche in materia di privacy per il nostro sito web. Spieghiamo come raccogliamo, utilizziamo e proteggiamo le informazioni personali dei nostri utenti. Al fine di garantire la massima trasparenza, forniamo informazioni dettagliate su come vengono gestiti i dati personali.</p>
  ...
  <p>Adottiamo misure di sicurezza adeguate per proteggere le informazioni personali degli utenti da accessi non autorizzati, modifiche, divulgazioni o distruzioni. Tuttavia, non possiamo garantire la sicurezza completa dei dati trasmessi attraverso Internet e gli utenti assumono il rischio di condividerli con noi.</p>

  <h2>Condivisione delle informazioni</h2>

  <p>Non condividiamo le informazioni personali degli utenti con terze parti, tranne che quando richiesto dalla legge o quando è necessario per fornire i servizi richiesti dagli utenti. In tali casi, richiederemo il consenso degli utenti prima di condividere le loro informazioni personali.</p>
  ...
  <p>Se gli utenti hanno domande o dubbi riguardo a questa informativa sulla privacy o alle pratiche del nostro sito web, possono contattarci tramite i dettagli forniti nella sezione di contatto del sito.</p>
